                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-6 d-flex align-items-stretch">
                            <div className="member" data-aos="fade-up" data-aos-delay={300}>
                                <div className="member-img">
                                    <img src={Bilal} className="img-fluid" alt />
                                    <div className="social">
                                        <a href='https://twitter.com/lly_11'><i className="bi bi-twitter" /></a>
                                        <a href='https://www.facebook.com/BiLly.s56/' target='_blank'><i className="bi bi-facebook" /></a>
                                        <a href='https://www.instagram.com/billy_s56/' target='_blank'><i className="bi bi-instagram" /></a>
                                        <a href='https://www.linkedin.com/in/bilal-shuja-a9a890118/' target='_blank'><i className="bi bi-linkedin" /></a>
                                    </div>
                                </div>
                                <div className="member-info">
                                    <h4>Bilal Shuja</h4>
